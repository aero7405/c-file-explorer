...
int main(void)
{
    ...
    DIR *user_dir = opendir(".");
    char *dir_arr[1024]; // beeg number of folders
    int dir_arr_length = 0;
    char curr_dir_path[256] = "./";
    ...
    { // while user_dir is open
        ...
        if (found_dir != NULL)
        {
            ...
            char* path = strcat(curr_dir_path, found_dir->d_name);
            printf("%s\n", found_dir->d_name);
        ...
        else
        {
            ...
            if (dir_arr_length > 0)
            {
                ...
                // TODO: I don't think this is correctly removing the first item of the array
